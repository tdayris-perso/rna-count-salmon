...
```{sh}
git clone https://github.com/gustaveroussy/rna-count-salmon.git
```

Everything is installed. Please, see the next page about [configurations](https://github.com/tdayris/rna-count-salmon/wiki/Configuration) before running. You can also see our [test] page if you want to test the [rna-count-salmon](https://github.com/tdayris/rna-count-salmon) pipeline.
## Local usage
...
params:
  ...
  salmon_index_extra: "--make-unique"
  salmon_quant_extra: "--bias --bootstrap-samples=100"
```
